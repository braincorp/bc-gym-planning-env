...
public:
    ...
    void clear_pixel(short x, short y, bool swap_xy,
                     int beam_width,
                     numpy_boost<boost::uint8_t, 2>& costmap) {
        //unswap (in reverse)
    ...
    bool bresenham_2d_precomputed(short x0, short y0, float r,
                                  const numpy_boost<boost::int16_t, 2>& line_defs, int index,
                                  numpy_boost<boost::uint8_t, 2>& costmap,
                                  float resolution,
    ...
    numpy_boost<boost::int16_t, 2> raytrace_2d_default_beam(const numpy_boost<boost::uint8_t, 2>& costmap,
                                                            ...
                                                            bool do_clearing, bool do_marking, boost::uint8_t mark_value){
    ...
    numpy_boost<boost::int16_t, 2> raytrace_2d(const numpy_boost<boost::uint8_t, 2>& costmap,
                                               const numpy_boost<boost::int16_t, 2>& line_defs,
                                               const numpy_boost<boost::int32_t, 1>& idx,
                                               const numpy_boost<float, 1>& ranges,
                                               const numpy_boost<boost::int16_t, 1>& pixel_origin,
    ...
    */
        ...
        std::vector<boost::int16_t> markings;
        numpy_boost<boost::uint8_t, 2>& writeable_costmap = *const_cast<numpy_boost<boost::uint8_t, 2>* > (&costmap);
        ...
        numpy_boost<boost::int16_t, 2> numpy_markings({ (int)markings.size() / 2, 2 });
        int j = 0;
    ...
    bool raytrace_2d_all_blindspot(const numpy_boost<boost::uint8_t, 2>& input_map,
                                   const numpy_boost<uint8_t, 2>& shadow_map,
                                   const numpy_boost<uint8_t, 2>& blindspot_map,
                                   const numpy_boost<boost::int16_t, 1>& origin,
                                   const numpy_boost<boost::int16_t, 1>& closest_blindspot,
                                   const boost::uint8_t obstacle_value,
       ...
       numpy_boost<boost::int16_t, 1> endpoint({ 2 });
       numpy_boost<boost::int16_t, 1> closest_found_candidate({ 2 });
       double min_distance = std::numeric_limits<double>::infinity();

       numpy_boost<uint8_t, 2>& writeable_blindspot_map = *const_cast<numpy_boost<uint8_t, 2>* > (&blindspot_map);
       numpy_boost<int16_t, 1>& writeable_closest_blindspot = *const_cast<numpy_boost<int16_t, 1>* > (&closest_blindspot);
    ...
    numpy_boost<boost::int16_t, 1>
         raytrace_2d_blindspot(const numpy_boost<boost::uint8_t, 2>& input_map,
                               const numpy_boost<uint8_t, 2>& shadow_map,
                               const numpy_boost<uint8_t, 2>& blindspot_map,
                               const numpy_boost<boost::int16_t, 1>& origin,
                               const numpy_boost<boost::int16_t, 1>& endpoint,
                               const boost::uint8_t obstacle_value,
                               int min_cluster_size,
                               bool return_once_marked){
        /**
        ...
        */
        ...
        numpy_boost<boost::int16_t, 1> closest_blindspot({ 2 });
    ...
    numpy_boost<boost::int16_t, 2> pixel_lidar(const numpy_boost<boost::uint8_t, 2>& input_map,
                                               const numpy_boost<boost::int16_t, 2>& line_defs,
                                               const numpy_boost<boost::int32_t, 1>& idx,
    ...
    */
        numpy_boost<boost::int16_t, 2> numpy_obstacles({ (int)idx.size(), 2 });
    ...
    bool raytrace_find_first_obstacle(const numpy_boost<boost::uint8_t, 2>& input_map,
                                      short origin_x, short origin_y,
                                      const numpy_boost<boost::int16_t, 1>& end_pose,
                                      const boost::uint8_t obstacle_value){
    /*  Same as raytrace_find_first_obstacle but end point is passed as numpy array,
        to be usable from python */
        numpy_boost<int16_t, 1>& writeable_end_pose = *const_cast<numpy_boost<int16_t, 1>* > (&end_pose);
    ...
    bool raytrace_find_first_obstacle_impl(const numpy_boost<boost::uint8_t, 2>& input_map,
                                           short origin_x, short origin_y,
    ...
    void raytrace_2d_all_shadows(const numpy_boost<boost::uint8_t, 2>& input_map,
                                 const numpy_boost<boost::uint8_t, 2>& output_map,
                                 const numpy_boost<boost::int16_t, 1>& origin,
                                 double max_distance_in_pixels,
                                 double min_angle,
                                 double max_angle,
    ...
    void raytrace_2d_shadows(const numpy_boost<boost::uint8_t, 2>& input_map,
                             const numpy_boost<boost::uint8_t, 2>& output_map,
                             const numpy_boost<boost::int16_t, 1>& origin,
                             const numpy_boost<boost::int16_t, 1>& endpoint,
                             const boost::uint8_t obstacle_value){
        ...
        */
        ...
        numpy_boost<uint8_t, 2>& writeable_output_map = *const_cast<numpy_boost<uint8_t, 2>* > (&output_map);
    ...
    void raytrace_clean_and_occupied(const numpy_boost<boost::uint16_t, 2>& clear_counts_map,
                                     const numpy_boost<boost::int16_t, 1>& origin,
        ...
        */
        ...
        numpy_boost<uint16_t, 2>& writeable_clear_counts_map = *const_cast<numpy_boost<uint16_t, 2>* > (&clear_counts_map);
    ...
    void raytrace_cliff(const numpy_boost<boost::uint8_t, 2>& costmap,
                        const numpy_boost<boost::int16_t, 2>& origins,
                        const numpy_boost<boost::int16_t, 2>& endpoints,
                        const numpy_boost<boost::uint8_t, 1>& marking_weights,
                        boost::uint8_t marking_threshold){
        /**
        ...
        */
        ...
        numpy_boost<uint8_t, 2>& writeable_costmap = *const_cast<numpy_boost<uint8_t, 2>* > (&costmap);
    ...
    numpy_boost<boost::int16_t, 2> raytrace_2d_glass(
        const numpy_boost<boost::uint8_t, 2>& costmap,
        const numpy_boost<boost::int16_t, 2>& line_defs,
        const numpy_boost<boost::int32_t, 1>& idx,
        const numpy_boost<float, 1>& ranges,
        const numpy_boost<boost::int16_t, 1>& pixel_origin,
    ...
    */
        ...
        numpy_boost<boost::int16_t, 2> numpy_markings({ (int)markings.size() / 3, 3 });
        int j = 0;
...
BOOST_PYTHON_MODULE(_wrapper_pixel_raytrace_module)
{
    import_array();
    ...
    numpy_boost_python_register_type<boost::uint16_t, 2>();
    ...
    py::class_<PixelRaytraceBoostWrapper, boost::noncopyable>(
        "PixelRaytraceWrapper", boost::python::init<>())
